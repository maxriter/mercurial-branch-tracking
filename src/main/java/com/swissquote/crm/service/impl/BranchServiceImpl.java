...
public class BranchServiceImpl implements BranchService {
	...
	@Override
	public Map<String, List<Commit>> getCommitsOfOpenedBranches(String projectName) {
	...
	public Projects getProjects() {
		List<String> allProjects = scriptExecutor.getProjectNames();
		Projects projects = new Projects();
		allProjects.forEach(projectName -> {
			Project project = new Project();
			project.setName(projectName);
			project.setCommitsByOpenedBranch(getCommitsOfOpenedBranches(projectName));
